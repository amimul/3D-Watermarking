...
public class CLONALG extends Classifier implements OptionHandler
{
	...
	public CLONALG()
	{
	    ...
	    antibodyPoolSize = 30; // N 30
	    selectionPoolSize = 20; // n 20
    ...
    public void buildClassifier(Instances data) throws Exception
    {
		...
		trainingInstances.deleteWithMissingClass();	//this deletes instances without class attribute
		for (int i = 0; i < trainingInstances.numAttributes(); i++)
		{
			trainingInstances.deleteWithMissing(i);		//this deletes instances which does not have attribute value
		}
		...
		algorithm = new CLONALGAlgorithm(
		        ...
		        numGenerations,
		        seed,
		        remainderPoolRatio);	//this sets values of various parameters which were initialised when clonalg constructor was called to the clonalgAlgorithm constructor.
