...
public class CLONALGAlgorithm implements Serializable
{
    ...
    protected void algorithmPreperation(Instances aAntigens)
    {
        ...
        int remainderSize = (int) Math.round(antibodyPoolSize * remainderPoolRatio);	//here 3
        int memorySize = (antibodyPoolSize - remainderSize);		//here 27
    	...
    	throws Exception
    {
        ...
        initialiseAntibodyPool(aAntigens);		//populates remainderpool and memorypool.
        ...
        for (int i = 0; i < numGenerations; i++)
        {
            ...
            {            
	            ...
	            calculateAffinity(remainderPool, currentInstance);	//calculates affinity of these antigens towards the antibodies present inside remainderpool.
	            calculateAffinity(memoryPool, currentInstance);		//calculates affinity of these antigens towards the antibodies present inside remainderpool.
	            
	            // locate the best n antibodies
	            Antibody [] bestSet = selectBestAntibodySet(currentInstance);	//in this method,a set of best antibodies is selected out of the memorypool and remainderpool.Selection is based on the affinity values.affinity is calculated using distance formula.lower the distance between antigen and antibody,higher the affinity.
